 ...
 * @author Nikola
 */
public class Igrac extends User implements GeneralEntity {
    ...
    public Igrac(String ime, String prezime, int userID, String username, String password, String email) {
        super(userID, username, password, email);
        this.ime = ime;
        this.prezime = prezime;
    }
    
    public Igrac(int userID,String ime, String prezime ) {        
        this.ime = ime;
        this.prezime = prezime;
        setUserID(userID);
    }
    ...
    public List<GeneralEntity> getList(ResultSet rs) throws Exception {
        ...
        while (rs.next()) {
            ...
            Igrac i = new Igrac(userID,ime, prezime );
    ...
    public GeneralEntity getEntity(ResultSet rs) throws Exception {
        ...
        if (rs.next()) {
            ...
            igrac = new Igrac(id,ime, prezime);
        }
        if (ime != null) {
            return igrac;
        } else {
